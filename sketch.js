...
var ground, invisibleGround, groundImage,gardenImg
...
function preload(){
  ...
  groundImage = loadImage("ground-Imgg.png");
  gardenImg = loadImage("garden-img.jpg")
...
function draw() {
  ...
  text("highScore "+highScore,270,120);
  console.log(trex.y)
